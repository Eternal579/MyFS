...
#define PRIMARY_ADDRESS_SCOPE 512L * 512L // 一次间址能覆盖的文件大小
#define SECONDARY_ADDRESS_SCOPE 512L * 512L * 512L // 二次间址能覆盖的文件大小
#define TRIPLE_ADDRESS_SCOPE 512L * 512L * 512L * 512L // 三次间址能覆盖的文件大小
